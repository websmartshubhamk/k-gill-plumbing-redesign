      ...
      <div className="relative z-10 section-container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/* WhatsApp Button */}
            <a
              href="https://wa.me/447990806810?text=Hi,%20I%20need%20help%20with%20plumbing/heating%20services"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-green-600 text-white rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-green-700 hover:scale-105 shadow-lg"
            >
